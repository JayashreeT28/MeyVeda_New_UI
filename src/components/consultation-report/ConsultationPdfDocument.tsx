...
const styles = StyleSheet.create({
  ...
  logoText: { fontSize: 24, fontWeight: 'bold', color: '#10b981' },
  subtitle: { fontSize: 9, color: '#64748b', marginTop: 4 },
  title: { fontSize: 16, fontWeight: 'bold', textAlign: 'center', marginTop: 15, color: '#0f172a' },
  section: { marginBottom: 15 },
  sectionTitle: { fontSize: 12, fontWeight: 'bold', borderBottom: '1 solid #e2e8f0', paddingBottom: 5, marginBottom: 10, color: '#1e293b' },
  ...
  tableColWide: { width: '40%', padding: '6 8', borderRightWidth: 1, borderColor: '#e2e8f0' },
  tableColNarrow: { width: '20%', padding: '6 8', borderRightWidth: 1, borderColor: '#e2e8f0' },
  tableColLast: { width: '20%', padding: '6 8' },
  tableCell: { fontSize: 9 },
  tableCellHeader: { fontSize: 9, fontWeight: 'bold', color: '#475569' },
        ...
        <View style={styles.section}>
          ...
          <View style={styles.grid}>
            ...
            <View style={styles.gridItem}>
              ...
              <Text style={styles.value}>{patient.age} y / {patient.gender}</Text>
            </View>
            <View style={styles.gridItem}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.table}>
              <View style={[styles.tableRow, styles.tableHeader]}>
                <View style={styles.tableColWide}><Text style={styles.tableCellHeader}>Medicine</Text></View>
                <View style={styles.tableColNarrow}><Text style={styles.tableCellHeader}>Dosage</Text></View>
                <View style={styles.tableColNarrow}><Text style={styles.tableCellHeader}>Frequency</Text></View>
                <View style={styles.tableColLast}><Text style={styles.tableCellHeader}>Duration</Text></View>
              </View>
                ...
                <View style={styles.tableRow} key={i}>
                  <View style={styles.tableColWide}>
                    ...
                    {item.special_instructions && (
                      <Text style={{...styles.tableCell, fontSize: 8, color: '#64748b', marginTop: 2}}>{item.special_instructions}</Text>
                    )}
                  </View>
                  ...
                  <View style={styles.tableColNarrow}>
                    ...
                    {item.anupana && (
                      <Text style={{...styles.tableCell, fontSize: 8, color: '#64748b', marginTop: 2}}>with {item.anupana}</Text>
                    )}
                  </View>
                  <View style={styles.tableColLast}>
                    <Text style={styles.tableCell}>{item.duration_days ? `${item.duration_days} days` : ""}</Text>
                  </View>
                </View>
              ))}
            </View>
